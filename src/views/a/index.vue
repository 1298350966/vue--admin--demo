<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="产品ID" width="150px" align="center">
      ...
      <el-table-column label="产品价格" width="150px" align="center">
        <template slot-scope="{ row }">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="产品图片:">
          <el-upload
            action="http://localhost:3000/swipe/upload"
        ...
        <el-form-item label="产品URL:">
          <el-input v-model="temp.roductUrl" />
        </el-form-item>
      </el-form>
...
import {swipeList,swipeUpload,swipeAddList,swipeDeleteList,swipeUpdateList} from "../../api/home"
...
export default {
  ...
  methods: {
    ...
    handleRemove(file, fileList) {
        console.log(file, "aaaa"+fileList);
