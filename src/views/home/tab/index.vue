  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="图片" width="110px" align="center">
        <template slot-scope="{row}">
          <el-image :src="row.url" lazy></el-image>
          {{row.url}}
        </template>
      </el-table-column>
      <!-- <el-table-column label="产品ID" width="600px" align="center">
        <template slot-scope="{ row }">
...
<script>
import { tabList, tabAddList, tabDeleteList, tabUpdateList } from "@/api/home";
